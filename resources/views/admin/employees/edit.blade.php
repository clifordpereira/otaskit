                    ...
                    <form method="POST" action="/employees/{{ $employee->id }}">
                        ...
                        <div class="form-group">
                            ...
                            <select name="department" id="department"
                                ...
                                <option value="Sales" @if ('Sales' == $employee->department) selected @endif>Sales</option>
                                <option value="Marketing" @if ('Marketing' == $employee->department) selected @endif>Marketing</option>
                                <option value="IT" @if ('IT' == $employee->department) selected @endif>IT</option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" id="status"
                                ...
                                <option value="1" @if (1 == $employee->status) selected @endif>Active</option>
                                <option value="0" @if (0 == $employee->status) selected @endif>Inactive</option>
                            </select>
